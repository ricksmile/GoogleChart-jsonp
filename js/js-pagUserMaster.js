...
function getDataTable(strSelectedID) {
    ...
    $.ajax({
        ...
        success: function (result) {
            try {
                var t = "<table id='member' class='table table-hover' width='400px'><tr>" +
	                               "<th><strong>ENTERPRISEID</strong></th> <th> " +
	                               "<strong>USERID</strong></th> <th> " +
	                               "<strong>USER_MASTER</strong></th><tr> ";
